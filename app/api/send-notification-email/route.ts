  ...
  try {
    ...
    switch (type) {
      case 'new_match':
        ...
        html = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <h1 style="color: var(--primary); text-align: center;">💕 New Match!</h1>
      ...
      case 'new_message':
        ...
        html = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            <h1 style="color: var(--primary); text-align: center;">💬 New Message</h1>
            <p style="font-size: 16px; line-height: 1.6; color: #333; text-align: center;">
      ...
      case 'account_warning':
        ...
        html = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p style="font-size: 16px; line-height: 1.6; color: #333;">
              Please review our <a href="https://openheartsdating.com/trust" style="color: var(--primary);">Trust & Safety guidelines</a>. Repeated violations may result in account suspension.
            </p>
            <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;" />
            <p style="font-size: 14px; color: #666; text-align: center;">
              The Open Hearts Dating Team
      ...
      case 'account_suspended':
        ...
        html = `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p style="font-size: 16px; line-height: 1.6; color: #333;">
              If you believe this is an error, contact us at <a href="mailto:contact@openheartsdating.com" style="color: var(--primary);">contact@openheartsdating.com</a>.
            </p>
            <hr style="border: none; border-top: 1px solid #eee; margin: 30px 0;" />
            <p style="font-size: 14px; color: #666; text-align: center;">
              The Open Hearts Dating Team
