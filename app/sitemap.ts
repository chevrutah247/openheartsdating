...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: '/mission', priority: 0.8, changeFrequency: 'weekly' as const },
    ...
    { path: '/volunteer', priority: 0.6, changeFrequency: 'monthly' as const },
    ...
    { path: '/ethics', priority: 0.5, changeFrequency: 'monthly' as const },
    { path: '/why-verification', priority: 0.6, changeFrequency: 'monthly' as const },
    { path: '/forum', priority: 0.6, changeFrequency: 'weekly' as const },
