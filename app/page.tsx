...
export const metadata: Metadata = {
  ...
  description: 'An inclusive, accessible dating platform for people with disabilities. Find meaningful connections with people who understand your journey.',
  openGraph: {
    title: 'Open Hearts Dating — Building Love Without Barriers',
    description: 'A nonprofit dating platform built by and for people with disabilities.',
  },
}
